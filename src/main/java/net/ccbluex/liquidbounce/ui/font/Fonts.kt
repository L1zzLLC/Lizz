...
object Fonts : MinecraftInstance {
    ...
    lateinit var fontTenacity30: GameFontRenderer
    ...
    fun loadFonts() {
        ...
        val time = measureTimeMillis {
            ...
            fontBorel55 = register(
                ...
                getFontFromFile2("Borel-Regular.ttf", 55).asGameFontRenderer()
            )

            fontBorel50 = register(
                FontInfo(name = "Borel", size = 50),
                getFontFromFile2("Borel-Regular.ttf", 50).asGameFontRenderer()
            )

            fontBorel45 = register(
                FontInfo(name = "Borel", size = 45),
                getFontFromFile2("Borel-Regular.ttf", 45).asGameFontRenderer()
            )

            fontTenacity30 = register(
                FontInfo(name = "Tenacity", size = 30),
                getFontFromFile2("tenacity.ttf", 30).asGameFontRenderer()
            )

            fontRise35 = register(
                FontInfo(name = "Rise", size = 35),
                getFontFromFile2("Rise.ttf", 35).asGameFontRenderer()
            )
    ...
    private fun getFontFromFileOrNull2(file: String, size: Int): Font? = try {
        val resourcePath = "/assets/minecraft/${CLIENT_NAME.lowercase()}/fonts/$file"

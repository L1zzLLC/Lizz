...
object HUD : Module("HUD", Category.RENDER, gameDetecting = false, defaultState = true, defaultHidden = true) {
    ...
    val hotbarBackgroundGlow by boolean("HotbarBackgroundGlow", false) { customHotbar }
    val hotbarBackgroundGlowRadius by int("HotbarBackgroundGlow-Radius", 4, 1..10) { customHotbar && hotbarBackgroundGlow }
    val hotbarBackgroundGlowColors = ColorSettingsInteger(this, "HotbarBackgroundGlow-Colors")
    { customHotbar && hotbarBackgroundGlow }.with(a = 150, r = 0, g = 255, b = 255)

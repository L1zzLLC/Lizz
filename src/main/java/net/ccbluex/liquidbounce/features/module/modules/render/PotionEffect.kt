...
object PotionEffect : Module("PotionEffect", Category.RENDER) {
    ...
    private class AnimatedPotion(var effect: PotionEffect) {
        ...
        fun draw(y: Float, xOffset: Float) {
            ...
            drawRoundedRect(startX, startY, startX + barWidth.get(), startY + animatedHeight, dataColor.rgb, rectRadius.get(),RenderUtils.RoundedCorners.LEFT_ONLY)
            ...
            Fonts.fontSemibold40.drawString(displayName, textX, textY, nameColor)
